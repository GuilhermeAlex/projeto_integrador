...
insert into tb_produto values (DEFAULT,'Porta Cartas e Correspondências, tamanho médio que comporta até revistas e pode ser instalado em paredes ou portas sob áreas cobertas como varandas, sacadas, consultórios, halls, condomínios etc. Ideal para quem já esta cansado de chegar em casa e ter que recolher aquele monte de correspondências, revistas e/ou jornais espalhados pelo chão, super facil de instalar!! Este é um produto exclusivo e ecológico, produzido com madeira reciclável extraída de caixas de fruta e feira, alem de ser confeccionado artesanalmente de forma sustentavel.', 9, 'https://i.imgur.com/uNOyeKy.jpg','Porta Cartas e Correspondências', 112.00,'32.0 x 15.0 cm',null,1, 2);
...
insert into tb_produto values (DEFAULT,'Cômoda de Pallets Personalizada.Estrutura em Pallets Reciclados, com 4 portas e 3 prateleiras ao centro. Acabamentos:Natural, Mogno, Imbuia, Nogueira, Cores Foscas.', 8, 'https://i.imgur.com/6afJHL5.jpg','Comoda de Pallets Personalizada', 1188.00,'70.0 x 60.0 cm ',null,3,3 );
