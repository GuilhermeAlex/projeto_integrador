...
-- Decoração / madeira 1,2
insert into tb_produto values (DEFAULT,'Feito a mão com madeira reciclável de pallets e caixas de frutas, este brinquedo é perfeito para presentear do nono aos netos! Este brinquedo possui detalhes como: bancos internos, volante, alavanca de cambrio, retrovisores laterais, estepe e muito mais.', 10, 'https://i.imgur.com/TEw0QTC.jpg','Caminhão Basculante de Madeira', 188.00,'12.0 x 9.0 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Banco Soft 40 feito artesanalmente com madeira reciclável de pinus este produto é super ecológico e sustentável. Esta é uma peça coringa que não pode faltar na decoração da sua casa, seja no quarto, sala, cozinha ou varanda, ele simplesmente vai preencher aquele canto vazio e dar um toque todo especial.', 9, 'https://i.imgur.com/8tbFVSy.jpg','Banco Soft 40', 129.76,'40.0 x 26.0 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Caixa de correio artesanal feita em madeira reciclável de caixa de frutas e feira, super versátil pode ser instalada no portão ou diretamente no muro. Saia da mesmice e destaque a entrada de sua casa das demais.', 8, 'https://i.imgur.com/n9ylWk4.jpg','Caixa de correio artesanal', 188.00,'33.0 x 20.0 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Esta peça é super versatil e sustentável, pois é confeccionada com madeira mista reciclada. Ideal para simplificar seu dia a dia na cozinha, mas tambem pode ser uma ótima opção para presentear com originalidade.', 7, 'https://i.imgur.com/J4zu5hB.jpg','Suporte Para Papel Toalha Pratick', 145.28,'17.0 x 15.0 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Móvel Porta Toalhas Artez confeccionado com madeira de pinus reciclável, peça exclusiva e ecologicamente sustentável desde a sua concepção.Ideal para quartos, suites, clossets ou para decorar aquele cantinho vazio a espera de algo especial, este móvel vem para organizar e decorar o espaço.', 7, 'https://i.imgur.com/klD9HdY.jpg','Móvel Porta Toalhas Artez', 140.00,'90.0 x 70.0 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Porta talher de mesa Echo, confeccionado com madeira reciclada de caixotes de feira e copos de plastico de requeijão (isso mesmo copos de plastico de requeijão!!), peça exclusiva elaborada pela marcenaria boraceia para decorar a sua casa ou presentear de forma original.', 8, 'https://i.imgur.com/yY2ISzi.jpg','Porta Talher de Mesa Echo', 92.80,'25.0 x 9.5 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Porta Cartas e Correspondências, tamanho médio que comporta até revistas e pode ser instalado em paredes ou portas sob áreas cobertas como varandas, sacadas, consultórios, halls, condomínios etc.', 9, 'https://i.imgur.com/uNOyeKy.jpg','Porta Cartas e Correspondências', 112.00,'32.0 x 15.0 cm',null,1, 2);
insert into tb_produto values (DEFAULT,'Porta revistas artesanal feito com madeira reciclável, esta peça é ideal para compor a decoração dos mais variados ambientes na sua casa ou escritório, alem de versátil este revisteiro é muito útil mantendo suas revistas e jornais sempre organizados. Bastante prático possui alça que facilita a remoção e limpeza. Este é um produto artesanal, confeccionado de maneira sustentável com madeira reciclada de pallets.', 9, 'https://i.imgur.com/S98Q6fF.jpg','Porta Revistas Artesanal em Madeira', 200.00,'43.0 x 16.0 cm',null,1, 2);
...
-- utensilios/ pallet
insert into tb_produto values (DEFAULT,'Nossos produtos são todos ecologicamente corretos pois utilizamos a política dos 3R - Reduzir, Reutilizar e Reciclar, com isso trazemos para os nossos clientes uma consciência ecológica e de preservação do meio ambiente.', 8, 'https://i.imgur.com/N4tn8jw.jpg','Armario de pallets',1200.00 ,'120.0 x 50.0 cm ',null,3,4);
insert into tb_produto values (DEFAULT,'Nossos produtos são todos ecologicamente corretos pois utilizamos a política dos 3R - Reduzir, Reutilizar e Reciclar, com isso trazemos para os nossos clientes uma consciência ecológica e de preservação do meio ambiente.', 10, 'https://i.imgur.com/EzJifHX.jpg','Baú de Pallets Grande', 432.00,'70.0 x 52.0 cm ',null,3,4);
insert into tb_produto values (DEFAULT,'Nossos produtos são todos ecologicamente corretos pois utilizamos a política dos 3R - Reduzir, Reutilizar e Reciclar, com isso trazemos para os nossos clientes uma consciência ecológica e de preservação do meio ambiente.', 9, 'https://i.imgur.com/N4tn8jw.jpg','Poltrona de Pallets', 270.00,'70.0 x 52.0 cm',null,3,4);
insert into tb_produto values (DEFAULT,'Linda base de sofá feita com pallets reciclados de único uso, são totalmente desmontados e lixados um a um, para melhor conservação do produto. Nossos produtos são todos ecologicamente corretos pois utilizamos a política dos 3R - Reduzir, Reutilizar e Reciclar, com isso trazemos para os nossos clientes uma consciência ecológica e de preservação do meio ambiente.', 6, 'https://i.imgur.com/XMcmmlO.jpg','Base de Sofá em pallets',486.00,'30.0 x 80.0 cm ',null,3,4 );
insert into tb_produto values (DEFAULT,'Linda Cama de Casal feita com pallets reciclados de único uso, são totalmente desmontados e lixados um a um, para melhor conservação do produto. Nossos produtos são todos ecologicamente corretos pois utilizamos a política dos 3R - Reduzir, Reutilizar e Reciclar, com isso trazemos para os nossos clientes uma consciência ecológica e de preservação do meio ambiente.', 8, 'https://i.imgur.com/M8eHuoz.jpg','Cama de Casal de pallets com gavetas', 594.00,'45.0 x 160.0 cm ',null,3,4);
insert into tb_produto values (DEFAULT,'Cômoda de Pallets Personalizada.Estrutura em Pallets Reciclados, com 4 portas e 3 prateleiras ao centro. Acabamentos:Natural, Mogno, Imbuia, Nogueira, Cores Foscas.', 8, 'https://i.imgur.com/6afJHL5.jpg','Comoda de Pallets Personalizada', 1188.00,'70.0 x 60.0 cm ',null,3,4 );
insert into tb_produto values (DEFAULT,'Home Office de Pallets. Estrutura em Pallets Reciclados, com 2 suportes para teclados com corrediças telescópicas, 2 armários e 2 gavetões no centro. Acabamentos:Natural, Mogno, Imbuia, Nogueira, Cores Foscas.', 7, 'https://i.imgur.com/OD2yYCD.jpg','Home Office de Pallets', 1350.00 ,'0.75 x 0.60 cm ',null,3,4);
insert into tb_produto values (DEFAULT,'Linda base de sofá feita com pallets reciclados de único uso, são totalmente desmontados e lixados um a um, para melhor conservação do produto. Nossos produtos são todos ecologicamente corretos pois utilizamos a política dos 3R - Reduzir, Reutilizar e Reciclar, com isso trazemos para os nossos clientes uma consciência ecológica e de preservação do meio ambiente.', 7, 'https://i.imgur.com/mN1Q6fL.jpg','Jogo de sofa de pallets e mesa de centro', 1080.00 ,'40.0 x 80.0 cm ',null,3,4 );
...
-- moveis/ pallet
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente feita de Pallet. Cama de casal Padrão feita de Pallets com tratamento anti cupim! Super resistente !! Madeira sustentável!', 80, 'https://i.imgur.com/cizNLZN.jpg','Cama feita de Pallets', 1200.00,'1,60 X 2,40 cm',null,4, 2);
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente com pallets.  Assento feito de pallets madeira reflorestada (Pínus), produzido com madeira seca e aparelhada. o banco de pallet duplo acomoda duas pessoas e no centro é possível observar a presença de uma mesa de madeira embutida na sua estrutura. Esse móvel além de servir como assento pode ser utilizado como apoio de objetos decorativos.',100, 'https://i.imgur.com/uAo5AK3.jpg','Banco feito de Pallets', 189.99,'0,80 x 0,60 cm',null,4,2);
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente com ripas de pallet reaproveitados para colocação de vasinhos de planta.', 40, 'https://i.imgur.com/YVdJqvx.jpg','Painel Pallet decorativo', 139.99,'1,20 x 1,00 cm',null,4,2);
insert into tb_produto values (DEFAULT,'A cama feita de palete também é perfeita para ambientes decorados com o estilo boho. Isso porque, a simplicidade da madeira completa a decoração casual do boho, que integra características de diferentes épocas e culturas, como as estampas e o ar místico do estilo hippie e as cores neutras do ambiente vintage.', 20, 'https://i.imgur.com/5Wp6I47.jpg','Cama no estilo boho', 1999.99,'1,60 X 2,40 cm',null,4,2);
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente com Pallet reciclavel. Mesa rústica feita toda de paletes para quem gosta de criatividade', 20, 'https://i.imgur.com/vw1U33Y.jpg','Mesa Rústica', 1299.00,'Grande',null,4,2);
insert into tb_produto values (DEFAULT,'Escrivaninha (mesa de computador, mesa de escritório) de pallet', 20, 'https://i.imgur.com/8im0rv1.jpg','Escrivaninha de Pallet', 699.99,'0,70 x 1,50 cm',null,4,2);
insert into tb_produto values (DEFAULT,'Rack feito com pallets, ideal para organizar seu ambiente', 20, 'https://i.imgur.com/bEHTj8L.jpg','Rack em pallet', 399.99,'0,70 x 1,50 cm',null,4,2);
