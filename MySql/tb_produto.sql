...
-- moveis/ pallet
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente feita de Pallet. Cama de casal Padrão feita de Pallets com tratamento anti cupim! Super resistente !! Madeira sustentável!', 80, 'https://i.imgur.com/cizNLZN.jpg','Cama feita de Pallets', 1200.00,'1,60 X 2,40 cm',null,4, 4);
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente com pallets.  Assento feito de pallets madeira reflorestada (Pínus), produzido com madeira seca e aparelhada. o banco de pallet duplo acomoda duas pessoas e no centro é possível observar a presença de uma mesa de madeira embutida na sua estrutura. Esse móvel além de servir como assento pode ser utilizado como apoio de objetos decorativos.',100, 'https://i.imgur.com/uAo5AK3.jpg','Banco feito de Pallets', 189.99,'0,80 x 0,60 cm',null,4,4);
insert into tb_produto values (DEFAULT,'Peça feita artesanalmente com ripas de pallet reaproveitados para colocação de vasinhos de planta.', 40, 'https://i.imgur.com/YVdJqvx.jpg','Painel Pallet decorativo', 139.99,'1,20 x 1,00 cm',null,4,4);
...
insert into tb_produto values (DEFAULT,'Escrivaninha (mesa de computador, mesa de escritório) de pallet', 20, 'https://i.imgur.com/8im0rv1.jpg','Escrivaninha de Pallet', 699.99,'0,70 x 1,50 cm',null,4,4);
insert into tb_produto values (DEFAULT,'Rack feito com pallets, ideal para organizar seu ambiente', 20, 'https://i.imgur.com/bEHTj8L.jpg','Rack em pallet', 399.99,'0,70 x 1,50 cm',null,4,4);
